...
const CONFIG = {
    ...
    facebook: "https://www.facebook.com/profile.php?id=100063637777241#",
    ...
    textos: {
        cat1: { t: "ABOUT US", c: "Catmania Sailing Charters and Catamaran Tours: Offering short-time sailing tours to Isla Mujeres, including snorkel tours, snacks, and domestic open bar. Daily departures from Punta Sam, Cancun, Mexico." },
        cat2: { t: "SERVICES", c: "Choose our standard tours or customize your own excursion: Shared trips to Isla Mujeres or exclusive private charters for groups, lessons, and luxury yachts." },
        cat3: { t: "HAPPY VOYAGERS", c: "The perfect day at sea. Professional crew, excellent service, and an unforgettable view of Isla Mujeres. Catmania is simply the best way to sail in Cancun." }
    }
};
...
// INTEGRACIÓN DE CARRUSEL AQUÍ (SIN BORRAR NADA DE LO SIGUIENTE)
function renderGallery(cat) {
    ...
    if (cat === 'cat3') {
        ...
        videoContainer.innerHTML = `
            <a href="https://www.youtube.com/shorts/PvReE4WgcXY" target="_blank" style="background: #000; color: #fff; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.7rem; border: 1px solid #d4af37;">Exceeded Expectations</a>
            <a href="https://www.youtube.com/shorts/8vsJB7oXjx4" target="_blank" style="background: #000; color: #fff; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.7rem; border: 1px solid #d4af37;">The Quality Assurance</a>
        `;
...
function updateViralUI() {
    ...
    if(currentShares >= 5) {
        ...
        if(overlay) { overlay.className = "viral-locked viral-unlocked"; overlay.innerHTML = `<i class="fas fa-gift"></i> <span>¡COUPON UNLOCKED: CONECTA CARD!</span>`; }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const mailLink = document.getElementById('link-mail-direct');
    if (mailLink) mailLink.href = "mailto:info@catmaniamx.com";
